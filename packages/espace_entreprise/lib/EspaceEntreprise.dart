...
class _EspaceEntreprisePageState extends State<EspaceEntreprisePage> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(covariant EspaceEntreprisePage oldWidget) {
                                    ...
                                    child: EntrepriseListWidget(
                                      ...
                                      onItemsLoaded: (entreprises) {
                                        setState(() {
                                          isLoading = false;
                                          /*   selectedEntreprise =
                                            entreprises.isNotEmpty ? entreprises.first : Entreprise();
                                     */
